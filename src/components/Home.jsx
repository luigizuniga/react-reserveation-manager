...
// Supongamos que tienes un array de canchas con información básica
const courts = [
  {
    id: 1,
    name: 'Cancha 1',
  ...
  return (
    <>
      <div className="columns is-centered">
        ...
        <button className="menu-button is-hidden-tablet" onClick={toggleMenu}>
          Mostrar Menú
        </button>

        <div className={`column ${showMenu ? 'is-2' : 'is-12'}`}>
          {/* Menú de navegación */}
